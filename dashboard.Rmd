...
plot_ly(
  ...
  layout(
    ...
    title = list(text = "Monthly tmax (\u00B0C) by season"),
    xaxis = list(title = list(text = "Month"), automargin = TRUE),
    yaxis = list(title = list(text = "tmax (\u00B0C)"), automargin = TRUE),
    margin = list(t = 70, b = 50, l = 60, r = 20)
  )
```
